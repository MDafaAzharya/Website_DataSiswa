                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Halo!Welcome!!!</h1>
                                        </div> 
                                        <form class="user" action="prosesregist.php" method="post"> 
                                                ...
                                                <div class="form-group">
                                                    <input type="password" class="form-control form-control-user"
                                                        id="pass" placeholder=" Confirm Password" name="pass">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user"
                                                        id="role" aria-describedby="emailHelp" name="role"
                                                        placeholder="Role">
                                                </div>
                                                <div class="form-group">
